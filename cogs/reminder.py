...
class Reminder(commands.Cog):
    ...
    async def remind(self, ctx: commands.Context, _time: str, *, reminder: str):
        ...
        await self.db.execute("INSERT INTO reminder VALUES ($1,$2,$3,$4)", unique_id, user_id, ttime, message)
    ...
    async def reminder(self, ctx: commands.Context):
        ...
        if len(res) == 0:
            return await ctx.reply(
                embed=discord.Embed(
                    description=":x: You don't have any upcoming reminders", color=discord.Color.red()
                )
            )
